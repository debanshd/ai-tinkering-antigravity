...
\begin{table}[htbp]
    ...
    \begin{center}
        ...
        \begin{tabular}{llcc}
            ...
            Dense Base & Single-Vector & Base & 0.001 ms* \\
            RL-Steered (Ours) & Dynamic Dense Routing & + 4.30 MB & 0.002 ms* \\
        \end{tabular}%
        }
    \end{center}
