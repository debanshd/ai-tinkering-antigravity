...
\begin{table}[htbp]
  ...
  \begin{center}
    ...
    \begin{tabular}{llcc}
      ...
      Supervised Baseline (BCE) & Strict Ground-Truth QRELs & 0.3294 & -3.43\% \\
      RL-Steered (PPO) & Ground-Truth Oracle Reward & 0.3330 & -2.37\% \\
