...
\begin{table}[htbp]
  ...
  \begin{center}
    ...
    \begin{tabular}{llccccccccccc}
      \multicolumn{1}{l}{\bf Dataset} & \multicolumn{1}{l}{\bf Domain} & \multicolumn{1}{c}{\bf Queries} & \multicolumn{1}{c}{\bf ColBERTv2} & \multicolumn{1}{c}{\bf SPLADE-v2} & \multicolumn{1}{c}{\bf COCO-DR} & \multicolumn{1}{c}{\bf BM25} & \multicolumn{1}{c}{\bf Dense Base} & \multicolumn{1}{c}{\bf Rocchio} & \multicolumn{1}{c}{\bf QDC} & \multicolumn{1}{c}{\bf HyDE}  & \multicolumn{1}{c}{\bf RL-Steered} & \multicolumn{1}{c}{\bf Rescue Rate} \\ \hline \\
      SciDocs & Scientific & 1,000 & \textbf{0.1670} & 0.1610 & 0.1700 & 0.1580 & 0.1490 & -- & -- & -- & 0.1620 & 4.1\% \\
      Arguana & Argumentative & 1,406 & 0.4680 & 0.5250 & \textbf{0.5400} & 0.3150 & 0.3411 & 0.3260 & 0.3214 & 0.3320 & 0.3330 & 2.7\% \\
...
A crucial critique of online retrieval correction is the severe algorithmic latency introduced during deployment. While Table~\ref{tab:compute_efficiency} establishes the isolated latency per query, production environments require sub-linear scaling under high concurrent loads. To definitively evaluate the deployment viability of the Context-Aware RL Router, we measured inference latency across increasing batch sizes (1, 16, 64, and 256 queries) on a single NVIDIA RTX 4090 GPU and contrasted it with existing PRF methods.
